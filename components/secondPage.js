    ...
    function renderHeader() {
        return (
            <View style={{ paddingHorizontal: SIZES.padding, paddingVertical: SIZES.padding, backgroundColor: COLORS.white }}>
                <View>
                    <Text style={{ color: COLORS.primary, ...FONTS.h2 }}>Expenses</Text>
                    <Text style={{ ...FONTS.h3, color: COLORS.darkgray }}>January 01,2023</Text>
                </View>
    ...
    function renderIncomingExpenses() {
        ...
        const renderItem = ({ item, index }) => (
            <View style={{
                ...
                >
                    <Text style={{ color: COLORS.white, ...FONTS.body3 }}>CONFIRM {item.total.toFixed(2)} Pesos</Text>
                </View>
            </View>
        )
        ...
        const renderItem = ({ item }) => (
            ...
            >
                ...
                <View style={{ justifyContent: 'center' }}>
                    <Text style={{ color: (selectedCategory && selectedCategory.name == item.name) ? COLORS.white : COLORS.primary, ...FONTS.h3 }}>{item.y} Pesos - {item.label}</Text>
                </View>
            </TouchableOpacity>
        )
